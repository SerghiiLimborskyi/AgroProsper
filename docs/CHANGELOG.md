# 🧠 AgroProsper DAO — Changelog v3.0.0
...
# 📦 CHANGELOG — DAO Studio 2025

## [v1.1-studio] — 2025-07-24

🎨 Додано DAO Studio 2025 — All Systems Active:
- Створено папку `studio/` з логотипами, NFT-бейджами, картами, QR-кодами
- Додано сторінку `studio.html` з галереєю DAO Studio
- Оновлено `gov-booklet.html` — інтегровано графіку DAO Studio
- Додано ZIP-архів `studio-kit.zip` для IPFS
- Активовано Telegram-команду `/dao_graphics`
- CI/CD автозбірка підтверджена (`deploy.yml`)
- README доповнено IPFS CID та описом студії

🔗 IPFS: `ipfs://bafybeidaostudio/studio-kit.zip`

🆕 CHANGELOG — DAO Brand Update
Дата: 2025-07-25 Автор: Serhii Limborskyi Версія: dao-fix-pack.mg

🔧 Зміни:
✅ Додано банер AGROPROSPER

Текст: “Empowering farmers with tailored financial solutions to help grow and sustain their agricultural operations.”

Кнопки: Get Started, Sign in

Меню: About, Services, Contact

Візуал: рука з рослиною та монетою

Розміщення: планується інтеграція в секцію HeroAgroQR на головній сторінці

✅ Додано логотип AGROPROSPER

Стилізована рослина з листям у зелених, синіх і жовтих тонах

Два сині кола — символ балансу та технологій

Текст: AGROPROSPER — темно-сині великі літери

Доступний у Media Kit та DAO Studio
...
README.md	✅ Оновлено	Додано офіційний опис бренду
